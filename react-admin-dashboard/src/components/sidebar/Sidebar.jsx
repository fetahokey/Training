import { AttachMoney, BarChart, ContactSupportOutlined, Dashboard, DynamicFeed, Home, LineStyle, MailOutline, PermIdentity, Report, Storefront, Timeline, TrendingUp, WorkOutline } from '@material-ui/icons';
            ...
            <div className="sidebarWarpper">
                <div className="sidebarMenu">
                    ...
                    <Link to="/" className="link"> 
                        ...
                        <Dashboard className="sidebarIcon"/> Analytics
                        </li>
                        <li className="sidebarListItem">
                        <TrendingUp className="sidebarIcon"/> Sales
                        </li>
                        <li className="sidebarListItem">
                        <LineStyle className="sidebarIcon"/> Inventory
                        </li>
                    </ul>
                </div>
                ...
                <div className="sidebarMenu">
                    ...
                    <ul className="sidebarList">
                        ...
                        <li className="sidebarListItem">
                        <ContactSupportOutlined className="sidebarIcon"/> Support
                        </li>
                    </ul>
                </div>
